...
class KITTIDataset(Dataset):
    def __init__(self, datapath, list_filename, training):
        ...
        self.left_filenames, self.right_filenames, self.disp_filenames, self.dx_gt_filenames, self.dy_gt_filenames = self.load_path(list_filename)
    ...
    def __getitem__(self, index):
        ...
        if self.training: ## training인 경우->크롭
            w, h = left_img.size
            ...
            top_pad = 384 - h # |
            right_pad = 1280 - w # ㅡ
            assert top_pad > 0 and right_pad > 0 # 1280*384보다 사진사이즈가 작아야만 해 !!-> 가장큰사진사이즈로 패딩해야대!!
            # pad images#
